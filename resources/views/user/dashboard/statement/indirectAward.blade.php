...
@section('title')
    In-Direct Busienss Reward 1st Level & 2nd Level Statement
@endsection
@section('head')
            ...
            <div class="row justify-content-center">
              <div class="col-md-12">
                <h1 class="h2 mb-2 text-center">
                    All In-Direct Busienss Reward 1st Level & 2nd Level Transactions <span class="text-primary">Statement</span>.
                </h1>
              </div>
            </div>
          </div>
