            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <h1 class="h2 mb-2 text-center">
                        All Direct Users <span class="text-primary">Statement</span>.
                    </h1>
                </div>
            </div>
        </div>
        <div class="block block-rounded" style="overflow: scroll">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    All Direct Users <small>Statement</small>
                </h3>
            </div>
                    ...
                    <tbody>
                        @forelse ($statement as $transaction)
                            <tr>
                                ...
                                <td class="text-center">${{ number_format(myPlanCount($transaction->id), 4) }}/-</td>
