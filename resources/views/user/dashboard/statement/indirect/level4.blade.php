...
@section('title')
    In-Direct Level 4 Team Commission's Statement
@endsection
@section('head')
            ...
            <div class="row justify-content-center">
              <div class="col-md-12">
                <h1 class="h2 mb-2 text-center">
                    All In-Direct Level 4 Team Commission's Transactions <span class="text-primary">Statement</span>.
                </h1>
              </div>
            </div>
          </div>
        <div class="block block-rounded"  style="overflow: scroll">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    All In-Direct Level 4 Commission's Transactions <small>Statement</small>
                </h3>
            </div>
